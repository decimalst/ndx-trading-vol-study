...
from src.treasury_offering_amounts import reconcile_offering
...
def main():
    ...
    checkpoint_path = rep / "TREASURY_PILOT_OFFERING_CHECKPOINT.json"
    ...
    private = root / "data/source_discovery/treasury_auction/offering_pilot_v1"
    report = rep / "TREASURY_PILOT_OFFERING.json"
